...
document.querySelectorAll(".day-tab").forEach(b=>b.addEventListener("click",()=>{document.querySelectorAll(".day-tab").forEach(x=>x.classList.remove("active"));b.classList.add("active");renderSchedule(b.dataset.day)}));renderSchedule(todayKey());
